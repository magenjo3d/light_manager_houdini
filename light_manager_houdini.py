...
class LightManagerTab(QWidget):
    ...
    def _show_light_manager_help(self):
        ...
        legend_text = (
            ...
            "- Select lights and backup lighting configuration setups.<br>"
            "- Snap button stores the selected light settings to a temp config file, and Load restores the exact configuration previously saved.<br><br>"
